...
// {
	...
	class Box_tfo_USAF : B_CargoNet_01_ammo_F {
	displayname = "[TFO] USAF Box";
		maximumLoad = 999999;
...
// UNIFORMS			
			class _xx_shy_afsoc_CombatUniform_mc {
				count = 5;
				name = "shy_afsoc_CombatUniform_mc";
			};
			class _xx_shy_afsoc_CombatUniform_wdl {
				count = 5;
				name = "shy_afsoc_CombatUniform_wdl";
			};
			class _xx_shy_afsoc_CombatUniform_dcu {
				count = 5;
				name = "shy_afsoc_CombatUniform_dcu";
			};
			class _xx_shy_afsoc_CombatUniform_acu {
				count = 5;
				name = "shy_afsoc_CombatUniform_acu";
			};
