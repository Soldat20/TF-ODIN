...
tfo_fnc_loadLoadout = 
{
	...
	if ((count _loadoutArray) == 0) exitWith {hint "Something went wrong and RSLO could not retrieve your load-out.";};
	...
	_goggles = ["G_Aviator","G_Shades_Green","G_Shades_Red","G_Shades_Black","G_Shades_Blue","G_Lowprofile","G_Sport_BlackWhite","G_Sport_Blackyellow","G_Sport_Red","G_Sport_Blackred"];
	{
